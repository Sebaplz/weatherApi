          ...
          <div className="max-w-xl w-full">
            <div className="w-full p-5 flex justify-between items-center">
              ...
              <BsFillMoonStarsFill
                ...
                size="26px"
                className="cursor-pointer text-[#0E172B] dark:text-slate-50"
              />
            </div>
            <article className="p-5">
              ...
              >
                <input
                  {...register("buscar", { required: "No puede estar vacio!" })}
            ...
            <article className="p-5 flex flex-col text-black dark:text-white">
              <section className="mb-8">
                <p className="text-3xl 2xl:text-4xl">
                  {Datos.location.country}
                </p>
                <p className="text-xl 2xl:text-2xl">{Datos.location.name}</p>
                <p className="text-xl 2xl:text-2xl">{Datos.location.region}</p>
              </section>
